...
export const GenreDetailsSection = styled.div`
  min-height: 100vh;
  position: relative;
...
export const GenreDetailsContainer = styled.div`
  max-width: 1100px;
  margin: 0 auto;
  display: flex;
...
export const GenreDetailsContent = styled.div`
  padding: 220px 0 0;
  max-width: 1100px;
  margin: 0 auto;
  display: flex;
...
export const GenreDetailsItem = styled.div`
  display: flex;
