...
export const PublisherDetailsSection = styled.div`
  min-height: 100vh;
  position: relative;
...
export const PublisherDetailsContainer = styled.div`
  max-width: 1100px;
  margin: 0 auto;
  display: flex;
...
export const PublisherDetailsGames = styled.div`
  max-width: 1280px;
  margin: 0 auto;
  padding: 7rem 30px 0;
  position: relative;
...
export const PublisherDetailsItem = styled.div`
  display: flex;
